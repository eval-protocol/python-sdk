...
The `RewardFunction` class is a core component of Eval Protocol, providing a unified interface for calling reward functions locally or remotely.
...
```python
from eval_protocol.reward_function import RewardFunction
```
...
```python
from eval_protocol import RewardFunction, EvaluateResult, MetricResult
