...
This document describes the core data models used in Eval Protocol for representing messages, evaluation results, and metrics.
...
While the classes provide strong typing for development, Eval Protocol also accepts dictionary representations for flexibility:
