...
This step-by-step tutorial will guide you through the process of creating, testing, and deploying your first reward function using Eval Protocol.
...
Now let's use the Eval Protocol CLI to preview our evaluation with the sample data:
