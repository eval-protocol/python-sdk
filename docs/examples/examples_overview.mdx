...
This page provides an overview of and links to documentation for various examples demonstrating the capabilities of the Eval Protocol. All documentation for these examples is self-contained within the `docs/` folder.
...
*   **GCP Cloud Run Deployment Example**:
    *   Shows how to deploy an Eval Protocol application on GCP Cloud Run.
...
*   **TRL Integration Example**:
    *   Shows how to integrate eval-protocol functions with the TRL library.
