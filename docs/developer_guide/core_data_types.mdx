...
This guide explains the primary data types used in Eval Protocol, including the input and output structures for reward functions.

## Overview

Eval Protocol uses several core data types to represent:
